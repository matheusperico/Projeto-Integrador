...
namespace ControleDeEstoque.Models
{
    internal class registraEntrada
    {
        ...
        public registraEntrada(int id, double quantidade, double valor, DateTime dataEntrada)
        {
            this.id = id;
        ...
        public async void registrarNovaEntrada(Boolean mostraMsg = true)
        {
            ...
            try
            {
                using (var connection = new SqliteConnection(connectionString))
                {
                    ...
                    string query = "INSERT INTO entrada (produto, qtde, valor, data_entrada) VALUES(@produto_id, @quantidade, @valor, @data_entrada)";
